          ...
          <div className="flex overflow-auto">
            ...
            <div className="p-5 flex gap-5">
              <Button
                ...
                className="border-none text-base font-bold w-36 hover:shadow-lg"
                onClick={showNewFolderModal}
              >
                {/* <FolderAddTwoTone className="mr-2 text-white" /> */}+ New
                Folder
              </Button>
              ...
              >
                {/* <FileTextTwoTone className="mr-2 text-white" /> */}+ New
                Prompt
              </Button>
            </div>
          </div>
                  ...
                  >
                    <div className="flex gap-5 p-16">
                      <Button
                        ...
                        style={{ backgroundColor: "#12BF80", color: "white" }}
                        className="border-none text-base font-extrabold w-36 hover:shadow-lg"
                      ...
                      <Button
                        ...
                        style={{ backgroundColor: "#12BF80", color: "white" }}
                        className="border-none  font-extrabold text-base w-36 hover:shadow-lg"
                        onClick={copyText}
                        size="large"
                      >
                        <CopyTwoTone />
